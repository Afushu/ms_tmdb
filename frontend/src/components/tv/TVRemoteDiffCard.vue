  ...
  >
    ...
    <template v-else-if="remoteDiffNotice">
      ...
      <div class="mt-2 flex flex-wrap items-center gap-2">
        <button v-if="remoteDiffNotice.remoteDetails.length" class="detail-alert-action" @click="onToggleRemoteDetails">
        ...
        <button class="detail-alert-action disabled:opacity-60" @click="onKeepLocal">暂不处理，保留本地</button>
      </div>
      ...
      <div v-if="showLocalOverrideDiffDetails && remoteDiffNotice.localOverrideDetails.length" class="detail-diff-list">
        <div
